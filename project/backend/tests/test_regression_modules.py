...
@pytest.mark.parametrize(
    "resource,expected",
    [
        # "unit_type" BİLİNÇLİ olarak eklendi (ekip katkısı, birim türü
        # farkındalıklı fakülte içe aktarımı). Opsiyoneldir: boş bırakılırsa
        # isimden türetilir, bu yüzden eski şablonla hazırlanmış dosyalar
        # çalışmaya devam eder. Bekleneni güncellemek şablonun SESSİZCE
        # kaymasına izin vermez; yalnızca kararlaştırılmış yeni sözleşmeyi
        # sabitler.
        ("faculties", "name,code,description,is_active,unit_type"),
