...
def get_overview(
    ...
    return build_overview(db, faculty_id, department_id, academic_program_id, academic_year)
...
def get_by_department(
    ...
    return build_department_analytics(db, faculty_id, department_id, academic_year)
...
def get_by_faculty(
    ...
    return build_faculty_analytics(db, faculty_id, academic_year)
