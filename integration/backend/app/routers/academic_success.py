...
def get_overview(
    ...
    """
    return UniversitySuccessOverview(**service.university_overview(db, academic_year))
...
def get_by_faculty(
    ...
    return [FacultySuccessRow(**row) for row in service.by_faculty(db, academic_year)]
...
def get_by_department(
    ...
    return [
        ...
        for row in service.by_department(db, academic_year, faculty_id)
    ]
...
def get_rankings(
    ...
    return SuccessRankings(**service.rankings(db, academic_year, level))
...
def get_correlations(
    ...
    return SuccessCorrelations(**service.correlations(db, academic_year))
