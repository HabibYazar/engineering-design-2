...
def get_scorecard(
    ...
    return KpiScorecard(**service.scorecard(db, academic_year))
...
def faculty_comparison(
    ...
    return [
        ...
        for row in service.faculty_comparison(db, academic_year)
    ]
...
def attention_list(
    ...
    return [
        StrategicKpiResponse(**row) for row in service.attention_list(db, academic_year)
    ]
